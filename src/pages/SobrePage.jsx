        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_1fr] gap-x-12 gap-y-16 items-center">
          <FadeIn>
            <div className="relative p-2 border bg-slate-50/50 rounded-2xl shadow-lg">
              <div className="absolute -top-16 -right-24 h-64 w-64 rounded-full bg-[radial-gradient(closest-side,rgba(17,179,163,0.12),transparent)] blur-2xl" />
          ...
          <div className="text-center lg:text-left">
            ...
            <FadeIn delay={0.4}>
              <div className="mt-10 flex justify-center lg:justify-start">
                <Button asChild size="lg" className="bg-primary text-white hover:bg-green-900">
                  <Link to="/contato">
